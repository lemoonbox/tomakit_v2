...
class T2TeachClass(models.Model):
    ...
    area_1=models.CharField(max_length=100,null=True, blank=True)
    sublocal_1=models.CharField(max_length=100,null=True, blank=True)
    sublocal_2=models.CharField(max_length=100,null=True, blank=True)
    sublocal_4=models.CharField(max_length=100,null=True, blank=True)
